<template>
  <div class="patent">
    ...
    >
      ...
      <el-table-column prop="petitioner" label="申请人"> </el-table-column>
    ...
    <el-dialog title="用户专利审核" :visible.sync="dialogVisible" width="40%">
      <el-row>
...
export default {
  ...
  methods: {
    sure() {
      ...
      Api.updateUserPatentByCodition(params)
        .then(res => {
          console.log(res)
          if (res.code == 0) {
