<template>
  <div class="articleList">
      ...
      <el-form :model="selectmodel" :inline="true">
        ...
        <el-form-item label="是否发布">
          <el-select v-model="selectmodel.isPublish" placeholder="请选择" clearable>
            ...
            <el-option key="2" label="审核拒绝" value="2"> </el-option>
          </el-select>
        </el-form-item>
    ...
    <el-dialog title="文章审核" :visible.sync="dialogVisible" width="40%">
      <el-row>
...
export default {
  ...
  methods: {
    ...
    seecomment(row) {
      console.log("row", row)
      ;(this.cpn = "articleCommentList"), (this.title = "评论列表")
      this.articleobj = row
      this.drawer = true
    },
    onsearch() {
    ...
    getuserdetail(row) {
      console.log(row)
      ;(this.cpn = "Articledetail"), (this.articleobj = row)
      this.drawer = true
    },
