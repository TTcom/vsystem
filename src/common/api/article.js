...
export default{
    ...
    queryArticleCommonReportListByCondition(params){   //文章评论举报列表接口
        return doPost({url:'queryArticleCommonReportListByCondition',data:params})
    },
    deleteArticleCommonReportByCondition (params){   //文章评论举报删除接口
        return doPost({url:'deleteArticleCommonReportByCondition',data:params})
    },
    authArticleCommonReportByCondition(params){   //文章评论举报审核接口
