    ...
    function(t, i, e) {
      ...
      ;(r.prototype.getModelMatrix = function() {
        ...
        (r.prototype.hitTestSimple = function(t, i, e) {
          ...
          if (r < 0) return !1
          for (
            var o = this.live2DModel.getTransformedPoints(r), n = this.live2DModel.getCanvasWidth(), s = 0, _ = this.live2DModel.getCanvasHeight(), a = 0, h = 0;
            h < o.length;
            h += 2
          ) {
            var l = o[h],
        ...
        !(function() {
          ...
          ;(i._$0s = 1),
              ...
              for (var o = 0, n = 0; n < e.CHANNEL_COUNT; n++) {
                ...
                if (0 == s);
                  ...
                  for (var h = 0; h < s; h++) {
                    ...
                    ;(l = ~~l), ($ = ~~$)
                    var a = this.clipContextList[o++]
                    ;(a.layoutChannelNo = n), (a.layoutBounds.x = 0.5 * l), (a.layoutBounds.y = 0.5 * $), (a.layoutBounds.width = 0.5), (a.layoutBounds.height = 0.5)
                  }
                else if (s <= 9)
                  for (var h = 0; h < s; h++) {
                    var l = h % 3,
            ...
            (f.prototype.update = function(t, i) {
              if (0 == this._$iP)
                return (
                  (this._$iP = this._$iT = i), void (this._$Fo = Math.sqrt((this.p1.x - this.p2.x) * (this.p1.x - this.p2.x) + (this.p1.y - this.p2.y) * (this.p1.y - this.p2.y)))
                )
          ...
          ;(It._$ni = function(t, i, e, r, o, n, s, _, a) {
            ...
            return (
              ...
              isNaN(l) &&
                ((l = (t - e - $ * s) / o),
                isNaN(l) && (l = (i - r - $ * _) / n),
                isNaN(l) && (console.log("a is NaN @UtVector#_$ni() "), console.log("v1x : " + o), console.log("v1x != 0 ? " + (0 != o)))),
            ...
            (v._$br = function(t, i, e, r) {
              ...
              if (4 == o) {
                var S = r[n[0]],
                  ...
                  B = s[3]
                return (
                  (1 - B) * ((1 - P) * ((1 - u) * (S + (v - S) * h) + u * (L + (M - L) * h)) + P * ((1 - u) * (E + (A - E) * h) + u * (I + (w - I) * h))) +
                  B * ((1 - P) * ((1 - u) * (x + (O - x) * h) + u * (D + (R - D) * h)) + P * ((1 - u) * (b + (F - b) * h) + u * (C + (N - C) * h)))
                )
              }
          ...
          ;(wt.STATE_FIRST = "STATE_FIRST"),
            ...
            (z.prototype._$Jr = function(t, i, e, r, o, n) {
              ...
              for (var _ = z._$To, a = z._$Po, h = 1, l = 0; l < 10; l++) {
                if (((a[0] = r[0] + h * o[0]), (a[1] = r[1] + h * o[1]), i._$nb(t, e, a, _, 1, 0, 2), (_[0] -= s[0]), (_[1] -= s[1]), 0 != _[0] || 0 != _[1]))
                ...
                if (((v = i[T]), (L = i[T + 1]), (P = v * _), (S = L * a), P < 0 || S < 0 || _ <= P || a <= S)) {
                  ...
                  if (!m) {
                    ;(m = !0),
                      ...
                      (f = 0.25 * (s[2 * (0 + 0 * M) + 1] + s[2 * (_ + 0 * M) + 1] + s[2 * (0 + a * M) + 1] + s[2 * (_ + a * M) + 1]))
                    ...
                    if (v <= 0)
                      if (L <= 0) {
                        ...
                        B + U <= 1
                          ...
                          : ((e[T] = x + (D - x) * (1 - B) + (b - x) * (1 - U)), (e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U)))
                      } else if (L >= 1) {
                        var b = s[2 * (0 + a * M)],
                          F = s[2 * (0 + a * M) + 1],
                          C = p - 2 * c + 1 * g,
                  ...
                  (l = P - (0 | P)),
                    ...
                    (h = 2 * ((0 | P) + (0 | S) * (_ + 1))),
                    l + $ < 1
                      ? ((e[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (_ + 1)] * $), (e[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (_ + 1) + 1] * $))
                      : ((e[T] = s[h + 2 * (_ + 1) + 2] * (l - 1 + $) + s[h + 2 * (_ + 1)] * (1 - l) + s[h + 2] * (1 - $)),
              ...
              for (var _, a, h, l, $, u, p, f = i, c = this._$o, d = this._$A, g = o * s, y = null != f._$hr ? f._$hr : f._$Cr, m = n; m < g; m += s)
                at._$ts
                  ? ((_ = e[m]),
                    ...
                    (p = a - l),
                    ($ = 2 * (h + l * (c + 1))))
                  : ((_ = e[m] * c), (a = e[m + 1] * d), (u = _ - (0 | _)), (p = a - (0 | a)), ($ = 2 * ((0 | _) + (0 | a) * (c + 1)))),
                  u + p < 1
                    ? ((r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (c + 1)] * p), (r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (c + 1) + 1] * p))
            ...
            (ct.prototype.startMotion = function(t, i) {
              for (var e = null, r = this.motions.length, o = 0; o < r; ++o)
                null != (e = this.motions[o]) &&
                  (e._$qS(e._$w0.getFadeOut()), this._$eb && _._$Ji("MotionQueueManager[size:%2d]->startMotion() / start _$K _$3 (m%d)\n", r, e._$sr))
              if (null == t) return -1
                  ...
                  if (null != r) {
                    ...
                    null != o
                      ? (o.updateParam(t, r),
                        (i = !0),
                        r.isFinished() &&
                          (this._$eb && _._$Ji("MotionQueueManager[size:%2d]->updateParam() / _$T0 _$w0 (m%d)\n", this.motions.length - 1, r._$sr), this.motions.splice(e, 1), e--))
        ...
        (o.prototype.tapEvent = function(t, i) {
          ...
          for (var e = 0; e < this.models.length; e++)
            this.models[e].hitTest($.default.HIT_AREA_HEAD, t, i)
              ...
              ? ($.default.DEBUG_LOG && console.log("Tap body. models[" + e + "]"), this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_BODY, $.default.PRIORITY_NORMAL))
              : this.models[e].hitTestCustom("head", t, i)
              ? ($.default.DEBUG_LOG && console.log("Tap face."), this.models[e].startRandomMotion($.default.MOTION_GROUP_FLICK_HEAD, $.default.PRIORITY_NORMAL))
    ...
    function(t, i, e) {
      ...
      ;(r.prototype.loadModelSetting = function(t, i) {
        ...
        (r.prototype.getMotionFile = function(t, i) {
          return null == this.json[this.MOTION_GROUPS] || null == this.json[this.MOTION_GROUPS][t] || null == this.json[this.MOTION_GROUPS][t][i]
            ? null
